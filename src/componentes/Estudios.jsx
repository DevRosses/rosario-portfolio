    ...
    <>
      <div className="contenedor">
        ...
        <p className="texto-estudios">
          ...
          universidad hasta los cursos online, he construido una base sólida en
          tecnologías como JavaScript, React, y más. Estos estudios no solo me
          han dado las habilidades técnicas, sino también la capacidad de pensar
